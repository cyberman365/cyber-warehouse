...
class Profile {
  constructor() {
    this.name = 'Wei Ling Tan';
    this.title = 'Senior Full Stack Devloper | Web';
    this.skills = [
      'React', 'NextJS', 'Redux', 'Express',
      'MySQL', 'MongoDB', 'Docker', 'AWS', 'TypeScript',
      'GraphQL', 'Git', 'Linux', 'Discord Development'
    ];
    this.hardWorker = true;
    this.quickLearner = true;
    this.problemSolver = true;
          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-12 lg:py-0">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Limitlessdream"
              ...
              {/* Floating badges */}
              <div className="hidden lg:block absolute left-[16rem] top-[2.3rem] animate-float-slow">
                <div className="px-4 py-3 rounded-lg bg-red-500/10 backdrop-blur-sm border border-red-500/20 text-red-400">
                  <i className="fas fa-wand-magic-sparkles"></i>&nbsp;&nbsp;
                  Innovation
                </div>
              </div>
              <div className="hidden lg:block absolute right-10 top-20 animate-float">
                <div className="px-4 py-3 rounded-lg bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 text-blue-400">
                  <i className="fas fa-code"></i>&nbsp;&nbsp;Clean Code
                </div>
              </div>
              <div className="hidden lg:block absolute top-[17rem] left-[70%] transform -translate-x-1/2 animate-float">
                <div className="px-4 py-3 rounded-lg bg-green-500/10 backdrop-blur-sm border border-green-500/20 text-green-400">
                  <i className="fas fa-lightbulb"></i>&nbsp;&nbsp;Scalable Code
                </div>
              </div>
            </div>
